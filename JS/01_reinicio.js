...
// en JS TODOS LOD DATOS HACEN CASTING a NUMBER -> NaN
let tipo= 'indefinido'
...
// Operadores
// Aritméticos: + - * / % ; de la operación resto;
// Operacion e asignación =
let x = 45
    x = 76
// Operadores de comparación
    //mayor menos mayor o igual  >,<, <=, >=,
    //operador x++ a x le suma x-- le resta uno a x
    //igualdad
 (x == 86)// Es x igual que 86 siempre devuelve un boolean false
 (x == 76) //Es x igual que 86 siempre devuelve un boolean true
 //identidad
 (x === "76") //comparador de tipo 
 //Negacion
 x != 50 //true  50 no es igual a 76
 x !== '50' // false  50 no es identico

 //6/3= 2
// parseInt(7/3) //2 solo coge entero 
//7/3%= 1 //solo cocje el resto le da igual lo demas 
